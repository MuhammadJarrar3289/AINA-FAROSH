...
Rectangle {
    ...
    Column {
            ...
            delegate: Rectangle {
                ...
                Row { anchors.fill: parent; anchors.margins: 8; spacing: 8; 
                    ...
                    Column { width: 100; spacing: 4; anchors.verticalCenter: parent.verticalCenter
                        ...
                        Row { spacing: 6; Text { text: "Embed:"; color: theme.textSecondary } Switch { checked: embed_override === undefined ? auto_detected_embed : embed_override; onCheckedChanged: { Project.setEmbedOverride(path, checked); } } }
                    }
                }
            }
        }
        ...
        Row { spacing: 8; Button { text: "Save manifest"; onClicked: Project.saveManifest("") } Button { text: "Load manifest"; onClicked: Project.loadManifest("") } }
    }
}
